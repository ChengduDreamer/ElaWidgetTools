#ifndef ELASIMPLEWINDOWPRIVATE_H
#define ELASIMPLEWINDOWPRIVATE_H
...
class ElaSimpleWindowPrivate : public QObject
{
    Q_OBJECT
    Q_D_CREATE(ElaSimpleWindow)
...
public:
    explicit ElaSimpleWindowPrivate(QObject* parent = nullptr);
    ~ElaSimpleWindowPrivate();
...
#endif // ELASIMPLEWINDOWPRIVATE_H
