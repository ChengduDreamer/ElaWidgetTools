#include "ElaSimpleWindowPrivate.h"
...
ElaSimpleWindowPrivate::ElaSimpleWindowPrivate(QObject* parent)
    : QObject{parent}
{
}

ElaSimpleWindowPrivate::~ElaSimpleWindowPrivate()
{
}

void ElaSimpleWindowPrivate::onNavigationButtonClicked()
{
...
void ElaSimpleWindowPrivate::onWMWindowClickedEvent(QVariantMap data)
{
...
void ElaSimpleWindowPrivate::onThemeReadyChange()
{
    Q_Q(ElaSimpleWindow);
    // 主题变更绘制窗口
...
void ElaSimpleWindowPrivate::onDisplayModeChanged()
{
...
void ElaSimpleWindowPrivate::onThemeModeChanged(ElaThemeType::ThemeMode themeMode)
{
    Q_Q(ElaSimpleWindow);
...
void ElaSimpleWindowPrivate::onNavigationNodeClicked(ElaNavigationType::NavigationNodeType nodeType, QString nodeKey)
{
...
void ElaSimpleWindowPrivate::onNavigationNodeAdded(ElaNavigationType::NavigationNodeType nodeType, QString nodeKey, QWidget* page)
{
...
qreal ElaSimpleWindowPrivate::_distance(QPoint point1, QPoint point2)
{
    return std::sqrt((point1.x() - point2.x()) * (point1.x() - point2.x()) + (point1.y() - point2.y()) * (point1.y() - point2.y()));
}

void ElaSimpleWindowPrivate::_resetWindowLayout(bool isAnimation)
{
    if (isAnimation)
    {
...
void ElaSimpleWindowPrivate::_doNavigationDisplayModeChange()
{
    Q_Q(ElaSimpleWindow);
