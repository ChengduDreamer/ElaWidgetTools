#ifndef ELASIMPLEWINDOW_H
#define ELASIMPLEWINDOW_H
...
#include "ElaAppBar.h"
#include "stdafx.h"
class ElaSimpleWindowPrivate;
class ELA_EXPORT ElaSimpleWindow : public QMainWindow
{
    Q_OBJECT
    Q_Q_CREATE(ElaSimpleWindow)
...
public:
    explicit ElaSimpleWindow(QWidget* parent = nullptr);
    ~ElaSimpleWindow();
